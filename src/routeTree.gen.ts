...
import { Route as WebhookToolRouteImport } from './routes/webhook-tool'
...
const WebhookToolRoute = WebhookToolRouteImport.update({
  id: '/webhook-tool',
  path: '/webhook-tool',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/webhook-tool': {
      id: '/webhook-tool'
      path: '/webhook-tool'
      fullPath: '/webhook-tool'
      preLoaderRoute: typeof WebhookToolRouteImport
